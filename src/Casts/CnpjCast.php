...
class CnpjCast implements CastsAttributes
{
    ...
    public function get(Model $model, string $key, mixed $value, array $attributes): mixed
    {
        ...
        $smValue = match ($this->dbType) {
            DBType::INTEGER => SM::onlyNumbers($value)->padL(14, '0'),
    ...
    public function set(Model $model, string $key, mixed $value, array $attributes): mixed
    {
        ...
        return match ($this->dbType) {
            ...
            DBType::FORMATTED => SM::onlyNumbers($value)->sub(0, 14)->padL(14, '0')->maskBrCnpj()->getString(),
            // DBType::STRING is default
            default => SM::onlyNumbers($value)->sub(0, 14)->padL(14, '0')->getString(),
        };
    }
}
